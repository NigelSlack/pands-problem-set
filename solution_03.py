...
#                System 'click' module  - for 'y/n' user response
# Arguments    : 'Help' can be accepted as a run time argument
#                None
#
# Versions     :
# 13/02/2019 NS Initial
#            NS Change check on comparison of 'i' to 1000 from != to <
#               Use 'if not click.confirm' rather than 'if click.confirm' - neater
#-------------------------------------------------------------------------------#
...
# ref https://pythonprogramminglanguage.com/text-output/
    ...
    print("Syntax : solution_03.py [help]\n ")
  else:
    print(" \nNo run time arguments required\n ")
  # end-if
 
# Ask the user if they wish to continue using 'click.confirm'. Otherwise the help
# text disappears off-screen with all the numbers being output. If the user enters
# 'y' the code continues, otherwise it stops.
...
# Output all numbers from start 'i' to 'i' <= 10000 adding 12 each time. As the start value is 
